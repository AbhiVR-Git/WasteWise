...
const prompts = [
    ...
    ["trust in Bhiwandi","ngos in Bhiwandi"],
    ["tell joke"],
  ...
  const replies = [
    ...
    ["Haha!","Good one!"],
    ["  The basic concept of this project  WASTEWISE is to collect theexcess/leftover food from donors such as hotels, restaurants, marriage halls, etc and distribute to  the  needy people"],
    [currentdate],
    [time],
    ["you can donate raw ,cooked and packed foods"],
    ["Nearby trusts, NGOs, Orphanages, Poor people, "],
    ["joke ha ha .."],
    ["You can package your cooked or raw food donations in airtight containers such as Tupperware or plastic bags. You can also use aluminum foil or cling wrap to keep the food fresh. Please make sure to label the containers with the type of food, date, and any relevant instructions"],
     ["Your donation will be used to support our mission and the various programs and initiatives that we have in place. Your donation will help us to continue providing assistance and support to those in need. You can find more information about our programs and initiatives on our web application"],
