...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" >Waste <b style="color: #06C167; ">Wise</b></p>
             <p class="user"></p>
...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"Mumbai City\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $mumbaicity=$ro3['count'];
            ...
            $pune=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"Nagpur\"";
...
var xplace=["Mumbai City","Pune","Nagpur"];
var yplace=[<?php echo json_encode($mumbaicity,JSON_HEX_TAG);?>,<?php echo json_encode($pune,JSON_HEX_TAG);?>,<?php echo json_encode($nagpur,JSON_HEX_TAG);?>];
